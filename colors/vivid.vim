...
exe 'hi! Statement guifg=' s:colors.keyword 'gui=bold,italic'
exe 'hi! Type guifg=' s:colors.statement 'gui=bold,italic'
exe 'hi! Special guifg=' s:colors.test 'gui=bold,italic'
...
exe 'hi! Keyword guifg=' s:colors.keyword 'gui=bold,italic'
...
exe 'hi! Function guifg=' s:colors.function 'gui=bold,italic'
exe 'hi! jsOperator guifg=' s:palette.red 'gui=bold'

" Vim javascript
exe 'hi! jsNoise guifg=' s:colors.noise 'gui=bold'
exe 'hi! jsVariableDef guifg=' s:colors.variable
exe 'hi! jsOperator guifg=' s:colors.keyword 'gui=bold'
exe 'hi! jsImport guifg=' s:colors.keyword 'gui=bold,italic'
exe 'hi! jsExport guifg=' s:colors.keyword 'gui=bold,italic'
exe 'hi! jsExportDefault guifg=' s:colors.keyword 'gui=bold,italic'
exe 'hi! jsModuleAs guifg=' s:palette.purple 'gui=bold,italic'
exe 'hi! jsFrom guifg=' s:colors.keyword 'gui=bold,italic'
...
exe 'hi! javaScriptConditional guifg=' s:colors.keyword 'gui=bold,italic'
